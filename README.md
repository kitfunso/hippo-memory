...
- **Cross-track R@5 status:** F8 hybrid tuning (MiniLM) 76.8, F9 v2 sub-agent LLM rerank (MiniLM) 78.0, F11 bge-base baseline 77.0, **F11+F9 stack (BGE-base + sub-agent rerank) 78.2 — new cross-track best, exploratory follow-up appended to F11 result doc**, F10 features-enriched (retracted) 59.2. Roadmap target R@5 ≥ 85% is NOT MET. NON-binding per each prereg.
