...
export function isPrivateScope(scope: string | null | undefined): boolean {
  if (Object.prototype.toString.call(scope) !== '[object String]') return false;
  // SAFETY: the toString.call check above confirms scope is a string.
  return PRIVATE_SCOPE_RE.test(scope as string);
}
