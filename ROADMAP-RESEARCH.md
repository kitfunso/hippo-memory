...
Cross-track aggregate: roadmap target R@5 ≥ 85% NOT MET by any of F8/F9/F10/F11/F11+F9. The current cross-track best is F11+F9 stack at R@5 = 78.2. The plausible next mechanism for closing the gap is a real cross-encoder evaluation (still blocked by HF egress as of 2026-05-11) or a query-aware mechanism beyond top-K sub-agent rerank.
