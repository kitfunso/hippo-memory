...
| Provenance coverage | Enterprise memory must answer who said what, when, and from where | before/after provenance feature | not yet present in schema | 100% of promoted receipts carry required provenance fields | blocked until schema work |
| Correction latency | Enterprise truth should update quickly when facts change | before/after correction flow | not yet instrumented | explicit timestamped delta from change receipt to supersession | blocked until instrumentation exists |
