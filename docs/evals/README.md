...
| [2026-09-24-mechanism-audit-round2-amendment-1.md](2026-09-24-mechanism-audit-round2-amendment-1.md) | Amendment: a second decay-default registration reused round 2's seeds 41-60 before the critique; R2b and R2d transfer from it, R2a and R2c move to seeds 101-120, the 365-day half-life and physics-off defaults are gated at npm release until the independent critique signs off |
| [2026-09-23-mechanism-audit-round2-result.md](2026-09-23-mechanism-audit-round2-result.md) | Result, round 2: round 1 replicates exactly; physics hurts under both scorers and ranks like cosine-only; the search recency factor hurts; sleep costs 3.6 pp hit@5 when credit goes only for text a memory holds; the outcome nudge alone carries the trap win; decay shows no effect on E1; R4 has no verdict (gate failed); independent critique included |
